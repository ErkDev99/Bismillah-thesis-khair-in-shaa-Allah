...
function SocialProofStrip() {
  return (
    <section
      ...
      className="py-10 px-4 bg-white dark:bg-stone-900 border-y border-stone-200 dark:border-stone-800"
    >
      <div className="max-w-5xl mx-auto">
        {/* Aggregate rating */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 mb-8">
          <div className="flex items-center gap-2">
            <span className="text-4xl font-bold text-stone-900 dark:text-amber-100 font-serif">4.9</span>
          ...
          <div className="flex items-center gap-2 text-sm text-stone-600 dark:text-stone-400">
            ...
            <span>
              Rated by <strong className="text-stone-900 dark:text-amber-100">524 verified travelers</strong>
            </span>
          </div>
          <div className="h-8 w-px bg-stone-300 dark:bg-stone-700 hidden sm:block" aria-hidden="true" />
          <Link
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {MINI_REVIEWS.map((r) => (
            <div
              key={r.name}
              className="flex items-start gap-3 p-4 bg-stone-50 dark:bg-stone-800/50 border border-stone-200 dark:border-stone-700"
            >
              <svg className="w-5 h-5 text-amber-400 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
