...
function TourOverview({ tour }: { tour: Tour }) {
  return (
    <section className="mb-12" aria-labelledby="overview-heading">
      <p className="text-emerald-700 dark:text-emerald-400 uppercase tracking-[0.3em] text-xs mb-1">About This Tour</p>
      <h2 id="overview-heading" className="text-2xl font-bold text-stone-900 dark:text-emerald-100 mb-4 font-serif">Overview</h2>
...
function TourHighlights({ tour }: { tour: Tour }) {
  return (
    <section className="mb-12" aria-labelledby="highlights-heading">
      <p className="text-emerald-700 dark:text-emerald-400 uppercase tracking-[0.3em] text-xs mb-1">What Awaits You</p>
      <h2 id="highlights-heading" className="text-2xl font-bold text-stone-900 dark:text-emerald-100 mb-4 font-serif">Highlights</h2>
      <NatureDivider className="mb-6 !justify-start" />
...
function TourItinerary({ tour }: { tour: Tour }) {
  return (
    <section className="mb-12" aria-labelledby="itinerary-heading">
      <p className="text-emerald-700 dark:text-emerald-400 uppercase tracking-[0.3em] text-xs mb-1">Day by Day</p>
      <h2 id="itinerary-heading" className="text-2xl font-bold text-stone-900 dark:text-emerald-100 mb-6 font-serif">Itinerary</h2>
      <NatureDivider className="mb-6 !justify-start" />
...
function TourInclusions({ tour }: { tour: Tour }) {
  return (
    <section className="mb-12" aria-labelledby="inclusions-heading">
      <p className="text-emerald-700 dark:text-emerald-400 uppercase tracking-[0.3em] text-xs mb-1">The Details</p>
